...
export class SelectOption extends Component {
  ...
  render() {
    ...
    return React.createElement(
      "div",
      { className: OptionClass, onClick: () => this.handleClick() },
      this.props.children
    );
  }
}
...
class SelectBody extends Component {
  ...
  removeBody(event) {
    if (!event.target.classList.contains('select-option')) ReactDOM.unmountComponentAtNode(this.props.container);
  }
  componentDidMount() {
...
class Select extends Component {
  ...
  render() {
    return React.createElement(
      "div",
      { className: "select", onClick: () => this.renderBody() },
